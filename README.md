...
- [Garage-Conversion & ADU Permit Timelines](https://github.com/asafichaki/permittimelines): 64,427 residential garage-to-ADU conversion permit applications for Los Angeles, San Diego, San Francisco and Seattle, with measured application-to-issuance waits, cohort completion rates and small-cell-suppressed aggregates. CC BY 4.0, reproducible from each city's official open-data portal.
